...
public class ingredientController implements Initializable {
    ...
    private void loadAllIngredients() {
        ...
        try {
            List<IngredientDTO> ingredientList = IngredientsRepo.getAll();
    ...
    void btnSaveOnAction(ActionEvent event) {
        ...
        IngredientDTO ingredient = new IngredientDTO(id, name, category,qty,price,supplier);
    ...
    void btnSearchOnAction(ActionEvent event) throws SQLException {
        ...
        IngredientDTO ingredient = IngredientsRepo.searchById(id);
        if (ingredient != null) {
