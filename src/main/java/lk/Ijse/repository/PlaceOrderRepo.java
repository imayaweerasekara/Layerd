...
public class PlaceOrderRepo {
    ...
    public static List<OrderDetailsDTO> getordersAll() throws SQLException {
        ...
        while (resultSet.next()) {
           ...
           OrderDetailsDTO orderDetails = new OrderDetailsDTO(order_id,date,time,table,cus_id,emp_id,itemId,unitPrice,qty,netTotal);
