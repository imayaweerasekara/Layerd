...
public class ReservationRepo {
    ...
    public static boolean save(ReservationDTO reservation) throws SQLException {
    ...
    public static boolean update(ReservationDTO reservation) throws SQLException {
    ...
    public static List<ReservationDTO> getAll() throws SQLException {
        ...
        List<ReservationDTO> bookingList = new ArrayList<>();
        ...
        while (resultSet.next()) {
            ...
            ReservationDTO reservation= new ReservationDTO(ReservationID,doR,Rdate,Rtime,empID,tableID,cusID,startTime,endTime,event);
    ...
    public static ReservationDTO searchById(String id) throws SQLException {
