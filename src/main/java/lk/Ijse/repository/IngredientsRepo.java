...
public class IngredientsRepo {
    public static boolean save(IngredientDTO ingredient) throws SQLException {
    ...
    public static boolean update(IngredientDTO ingredient) throws SQLException {
    ...
    public static List<IngredientDTO> getAll() throws SQLException {
        ...
        while (resultSet.next()) {
            ...
            IngredientDTO ingredient = new IngredientDTO(id, name, category, qty_available,price, supplier);
            ingredientList.add(ingredient);
        }
        return ingredientList;
    }

    public static IngredientDTO searchById(String id) throws SQLException {
